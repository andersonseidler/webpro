                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="firstname" name="name" value="{{ $employee->name ?? old('name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="lastname" class="form-label">E-mail</label>
                                <input type="text" class="form-control" id="lastname" name="email" value="{{ $employee->email ?? old('email') }}">
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="useremail" name="telefone" value="{{ $employee->telefone ?? old('telefone') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="userpassword" class="form-label">Cargo</label>
                                <input type="text" class="form-control" id="cargo" name="cargo" value="{{ $employee->cargo ?? old('cargo') }}">
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="nascimento" value="{{ $employee->nascimento ?? old('nascimento') }}" class="form-control" placeholder=" " required />
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="cep" onblur="pesquisacep(this.value);" onkeyup="this.value = formatCEP(this.value)" value="{{ $employee->cep ?? old('cep') }}" id="cep" class="form-control" placeholder=" " required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="cwebsite" class="form-label">Logradouro</label>
                                <input type="text" name="logradouro" value="{{ $employee->logradouro ?? old('logradouro') }}" id="rua" class="form-control" placeholder=" " required />
                            </div>
                        </div> <!-- end col -->
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="cidade" value="{{ $employee->bairro ?? old('bairro') }}" id="bairro" class="form-control" required />
                            </div>
                        </div> <!-- end col -->
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="cwebsite" class="form-label">Cidade</label>
                                <input type="text" name="cidade" value="{{ $employee->cidade ?? old('cidade') }}" id="cidade" class="form-control" required />
                            </div>
                        </div> <!-- end col -->
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="estado" value="{{ $employee->estado ?? old('estado') }}" id="uf" class="form-control" required />
                            </div>
                        </div> <!-- end col -->
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="cwebsite" class="form-label">Complemento</label>
                                <input type="text" name="complemento" value="{{ $employee->complemento ?? old('complemento') }}" id="complemento" class="form-control"/>
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
